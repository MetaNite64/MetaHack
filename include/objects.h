...
POTION("restore ability",        "pink",  1, 0, 40, 100, CLR_BRIGHT_MAGENTA,
                                                        POT_RESTORE_ABILITY),
POTION("confusion",            "orange",  1, CONFUSION, 30, 100, CLR_ORANGE,
                                                        POT_CONFUSION),
POTION("blindness",            "yellow",  1, BLINDED, 30, 150, CLR_YELLOW,
                                                        POT_BLINDNESS),
POTION("paralysis",           "emerald",  1, 0, 30, 300, CLR_BRIGHT_GREEN,
                                                        POT_PARALYSIS),
POTION("speed",            "forest green",  1, FAST, 40, 200, CLR_GREEN,
                                                        POT_SPEED),
POTION("levitation",             "cyan",  1, LEVITATION, 40, 200, CLR_CYAN,
                                                        POT_LEVITATION),
POTION("hallucination",      "sky blue",  1, HALLUC, 30, 100, CLR_CYAN,
                                                        POT_HALLUCINATION),
POTION("invisibility", "ocean blue",  1, INVIS, 40, 150, CLR_BRIGHT_BLUE,
                                                        POT_INVISIBILITY),
POTION("see invisible",       "magenta",  1, SEE_INVIS, 40, 50, CLR_MAGENTA,
                                                        POT_SEE_INVISIBLE),
POTION("healing",          "amaranth",  1, 0, 115, 20, CLR_MAGENTA,
                                                        POT_HEALING),
POTION("extra healing",          "lavender",  1, 0, 45, 100, CLR_RED,
                                                        POT_EXTRA_HEALING),
POTION("gain level",            "milky",  1, 0, 20, 300, CLR_WHITE,
                                                        POT_GAIN_LEVEL),
POTION("enlightenment",        "vermilion",  1, 0, 20, 200, CLR_ORANGE,
                                                        POT_ENLIGHTENMENT),
POTION("monster detection",    "cinnabar",  1, 0, 30, 150, CLR_RED,
                                                        POT_MONSTER_DETECTION),
POTION("object detection",      "smoky",  1, 0, 30, 150, CLR_GRAY,
                                                        POT_OBJECT_DETECTION),
POTION("gain energy",          "amber",  1, 0, 40, 150, CLR_ORANGE,
                                                        POT_GAIN_ENERGY),
POTION("sleeping",       "butterscotch",  1, 0, 40, 100, CLR_YELLOW,
                                                        POT_SLEEPING),
...
POTION("booze",                 "brown",  0, 0, 40,  50, CLR_BROWN,
                                                        POT_BOOZE),
POTION("sickness",              "chartreuse",  0, 0, 40,  50, CLR_BRIGHT_GREEN,
                                                        POT_SICKNESS),
POTION("fruit juice",            "asparagus green",  0, 0, 40,  50, CLR_GREEN,
                                                        POT_FRUIT_JUICE),
POTION("acid",                  "white",  0, 0, 10, 250, CLR_WHITE,
                                                        POT_ACID),
POTION("oil",                   "teal",  0, 0, 30, 250, CLR_CYAN,
                                                        POT_OIL),
POTION("ESP",			"mauve",  1, TELEPAT, 20, 250, CLR_BRIGHT_MAGENTA,
							POT_ESP),
POTION("antimagic",		"grape",  1, ANTIMAGIC, 10, 300, CLR_MAGENTA,
							POT_ANTIMAGIC),
POTION("phasing",		"royal purple",  1, PASSES_WALLS, 10, 250, CLR_MAGENTA,
							POT_PHASING),
/* fixed description
 */
